...
module.exports = {
    ...
    schemas: {
        ...
        signupAuthSchema: Joi.object().keys({
            resaddre: Joi.string().required().allow('', null).insensitive().lowercase(),
            firstname: Joi.string().required().allow('', null).insensitive().lowercase(),
            city: Joi.string().required().allow('', null).insensitive().lowercase(),
            lastname: Joi.string().required().allow('', null).insensitive().lowercase(),
            zip: Joi.string().required().allow('', null).insensitive().lowercase(),
            email: Joi.string().email().required(),
            password: Joi.string().required(),
